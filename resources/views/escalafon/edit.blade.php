    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                {!!Form::model($escalafon,['method'=>'PATCH','route'=>['escalafones.update',$escalafon->cod_escalafon],'files'=>true, 'class'=>'big-form'])!!} {{Form::token()}}
                    ...
                    <div class="contenedor-lugar">
                        ...
                        <select id="tipo_escalafon" name="tipo">
							             @foreach($tipos as $tipo)
							             	@if($escalafon->tipo_escalafon==$tipo->cod_escalafon)
							             		<option value="{{$tipo->cod_escalafon}}" selected="">{{$tipo->nombre_escalafon}}</option>
							             	@else
